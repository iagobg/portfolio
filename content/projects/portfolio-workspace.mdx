...
outcomes:
  - "One MDX file feeds the explorer, archive, filters, command palette, sitemap, and case pages."
  - "Portuguese is now the primary route family, with English preserved under /en."
  - "The modular VPS deployment lets each project redeploy without restarting the whole portfolio stack."
---
