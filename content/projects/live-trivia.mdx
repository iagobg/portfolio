...
outcomes:
  - "Authoritative room state stays in OTP processes while LiveView renders the canonical game flow."
  - "High-frequency typing bubbles moved to Phoenix Channels with compact payloads to avoid unnecessary LiveView diffs."
  - "The 16-player synthetic benchmark now runs around 0.7% CPU on the Oracle VPS deployment."
---
