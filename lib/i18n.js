...
export const dictionaries = {
  en: {
    ...
    contactKicker: "Available for collaboration",
    contactTitle: "I build practical software with clear product boundaries.",
    contactCopy:
      "The case studies here show how I reason through tradeoffs, ship usable systems, and keep implementation details tied to real user needs.",
    contactPrimary: "Browse case studies",
    contactSecondary: "Open GitHub",
    ...
    commands: {
      ...
      detail: (count) => `${count} project${count === 1 ? "" : "s"}`,
  ...
  "pt-BR": {
    ...
    contactKicker: "Disponível para colaboração",
    contactTitle: "Eu construo software prático com limites de produto bem definidos.",
    contactCopy:
      "Os estudos de caso mostram como eu penso tradeoffs, publico sistemas usáveis e mantenho decisões técnicas conectadas a necessidades reais.",
    contactPrimary: "Ver estudos de caso",
    contactSecondary: "Abrir GitHub",
    caseBrief: "Resumo do case",
    problem: "Problema",
    solution: "Solução",
    role: "Meu papel",
    outcomes: "Resultados",
    ...
    commands: {
      ...
      detail: (count) => `${count} projeto${count === 1 ? "" : "s"}`,
...
export function getLocaleFromPath(pathname = "/") {
  if (pathname === `/${PT_BR}` || pathname.startsWith(`/${PT_BR}/`)) return PT_BR;
...
export function stripLocale(pathname = "/") {
  ...
  if (pathname.startsWith(`/${EN}/`)) return pathname.slice(EN.length + 1) || "/";
  return pathname;
}
